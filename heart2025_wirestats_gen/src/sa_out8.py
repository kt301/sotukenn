...
def main():  
    ...
    print(f"\nTotal {len(sortedWireStats)} unique wires used (sum). Saving to wire_stats8.txt...")
    with open("wire_stats8.txt", "w") as f:
    ...
    # レポートをファイルとコンソールに出力
    cost_report_file = "final_architecture_cost8.txt"
