...
# (手順2)で生成した、MUXごとの入力本数ファイルのパス
IMUX_COUNT_FILE = "imux_in.txt"

# (手順3)で出力する、最終的なアーキテクチャのファイル名
OUTPUT_FILE = "wirestat_final.txt"

# (手順2)で imux_in.txt を生成する際に「使用した」閾値
# ★重要★: count_imux_in.py の THRESHOLD と必ず「同じ値」にしてください
THRESHOLD = 10 
