...
def main():  
    ...
    print(f"\nTotal {len(sortedWireStats)} unique wires used (sum). Saving to wire_stats9.txt...")
    ...
    # レポートをファイルとコンソールに出力
    cost_report_file = "final_architecture_cost9.txt"
