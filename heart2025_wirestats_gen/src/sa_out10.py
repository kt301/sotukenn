...
def main():  
    ...
    print(f"\nTotal {len(sortedWireStats)} unique wires used (sum). Saving to wire_stats10.txt...")
    with open("wire_stats10.txt", "w") as f:
    ...
    # レポートをファイルとコンソールに出力
    cost_report_file = "final_architecture_cost10.txt"
    ...
    print("SA_out10.py run complete.")
