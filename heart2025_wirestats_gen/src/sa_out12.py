...
def main():  
    ...
    print(f"\nTotal {len(sortedWireStats)} unique wires used (sum). Saving to wire_stats12.txt...")
    with open("wire_stats12.txt", "w") as f:
    ...
    # レポートをファイルとコンソールに出力
    cost_report_file = "final_architecture_cost12.txt"
    ...
    print("SA_out12.py run complete.")
