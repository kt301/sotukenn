...
def main():  
    ...
    print(f"\nTotal {len(sortedWireStats)} unique wires used (sum). Saving to wire_stats5.txt...")
    with open("wire_stats5.txt", "w") as f:
    ...
    # レポートをファイルとコンソールに出力
    cost_report_file = "final_architecture_cost5.txt"
